...
import {ProxySender} from "./ProxySender.sol";

contract SenderFactory {
    /// @notice CoinbaseSmartWalletFactory address
    ...
    constructor(address smartWalletFactory_, address implementation_) payable {
